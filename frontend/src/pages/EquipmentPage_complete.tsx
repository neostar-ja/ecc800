...
const EquipmentPage: React.FC = () => {
  ...
  }, [selectedEquipment, selectedSite, newEquipmentName, refetch, equipmentDetails]);
                    ...
                    {filteredEquipment.map((item) => (
                      <TableRow key={item.equipment_id || `eq-${Math.random()}`} hover>
                        ...
                        <TableCell>
                          <Box>
                            <Typography variant="body2" fontWeight="bold">
                              {item.equipment_name || 'ไม่ระบุ'}
                            </Typography>
                            {item.original_name && item.original_name !== item.equipment_name && (
            ...
            <Box display="flex" alignItems="center">
              ...
              <Box>
                <Typography variant="h6">
                  รายละเอียดอุปกรณ์: {selectedEquipment?.equipment_id}
                </Typography>
